...
import { StyledTextField, StyledLabel, StyledH1 } from './AddRecipePage.styled';
        ...
        <div className={CSS.container}>
            <div className={CSS.test}>
                <div className={CSS.rectangles}>
                    ...
                    <svg
                        className={CSS.rectangle_9_position}
                        width="18"
                        height="18"
                        viewBox="0 0 18 18"
                        fill="none"
                ...
                <div className={CSS.ZAGALOM}>
                    <div className={CSS.lef_column}>
                        ...
                        <div className={CSS.section2}>
                            <h3 className={CSS.section2_title}>Ingredients</h3>

                            <div className={CSS.testtest}>
                                +
                                <input class="cart_item__input_count" type="number" name="input_count" min="1" />-
                            </div>
                        </div>
                        <div className={CSS.section3}>
                            <h3 className={CSS.section3_title}>Recipe Preparation</h3>
                    ...
                    <div className={CSS.right_column}>
                        ...
                        <ul className={CSS.Fallow_us}>
                            <li className="fallow-social-link">
                                ...
                                >
                                    <svg
                                        className={CSS.fallow_social_icon}
                                        viewBox="0 0 26 26"
                                        fill="none"
                                        xmlns="http://www.w3.org/2000/svg"
                                    >
                        ...
                        <ul className={CSS.popular_recipe}>
                            ...
                            <li className={CSS.popular_item}>
                                ...
                                <div>
                                    <h3>Baked salmon</h3>
                                    <p className={CSS.popular_item_description}>
                                        Cook in boiling salted water for 10 mins...
                                    </p>
                                </div>
                            </li>
                            <li className={CSS.popular_item}>
                                ...
                                <div>
                                    <h3>Sugar Pie</h3>
                                    <p className={CSS.popular_item_description}>
                                        Sugar pie is a dessert in northern French and Belgiancuisine, where it is called
                                        tarte...
                                    </p>
                                </div>
                            </li>
