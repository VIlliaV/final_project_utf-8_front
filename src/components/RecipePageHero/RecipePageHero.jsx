...
import { TitleRecipe, Description, Button, ClockWrapper, Time, TimeWrapper } from './RecipePageHero.styled';
...
const RecipePageHero = ({ title, description, time }) => {
    return (
        <>
            ...
            <Description>
                {description}
                Is a healthy salad recipe that’s big on nutrients and flavor. A moist, pan seared salmon is layered on
                top of spinach, avocado, tomatoes, and red onions. Then drizzled with a homemade lemon vinaigrette.
            </Description>
