...
import footerkissingmob from './images/kisspng-pasta-spinach-dip-english-muffin-breakfast-sandwic.png';
import footerkissingtab from './images/kisspng-pasta-spinach-dip-english-muffin-breakfast-sandwic-tab.png';
import footerkissingdesk from './images/kisspng-pasta-spinach-dip-english-muffin-breakfast-sandwic-desk.png';
import footerkissingmob2 from './images/kisspng-pasta-spinach-dip-english-muffin-breakfast-sandwic-mob@2x.png';
import footerkissingtab2 from './images/kisspng-pasta-spinach-dip-english-muffin-breakfast-sandwic-tab@2x.png';
import footerkissingdesk2 from './images/kisspng-pasta-spinach-dip-english-muffin-breakfast-sandwic-desk@2x.png';
...
export const Copyright = styled.div`
  ...
  background-image: url(${footerkissingmob});
  ...
  @media ${media.mobile + media.retina} {
		background-image: url(${footerkissingmob2});
  ...
  @media ${media.tablet} {
    ...
    line-height: 18px;
    letter-spacing: -0.28px;
	background-image: url(${footerkissingtab});
  ...
  @media ${media.tablet + media.retina} {
		background-image: url(${footerkissingtab2});
		background-position: right 0px bottom -20px;
     background-repeat: no-repeat;
	 background-size: 438px auto;
  }
  ...
  @media ${media.desktop} {
	background-image: url(${footerkissingdesk});
	background-position: right 0px bottom -15px;
    background-repeat: no-repeat;
    background-size: 438px auto;
  }
    @media ${media.desktop + media.retina} {
		background-image: url(${footerkissingdesk2});
		background-position: right 0px bottom -15px;
     background-repeat: no-repeat;
     background-size: 438px auto;
  }
