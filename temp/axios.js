...
//! axois.post('/shopping-list', {ingredientId:'id інгредієнту', measure: "measure інгредієнту", identId: "новий id картки"}); --ендпоінт для додавання продукту в список покупок користувача
// axois.patch('/shopping-list', {id:'id інгредієнту'}); -- --ендпоінт для видалення продукту в список покупок користувача. //! id дорівнює identId
