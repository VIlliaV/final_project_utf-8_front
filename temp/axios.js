...
// 1. ❔ register чи user/register ?
// 2. ❔ x-www-form-urlencoded ?
// 3. 🔥 Додавання у шопінг лист має бути з прив'язкою до кількості (amount, number)
// 4. 🔥 Видалення проходить по id, а має видалятись з залежністю до amount.
// 5. Чи буде в нас можливість remove user?

// 6. ❔ Може зробити export для setAuthHeader? Бо все одно використовується в усіх запитах після авторизації
// 7. ❔ Яку логіку краще робити при видаленні інгредієнту з переліку покупок?
...
// 8. Що робить fetchCurrentUser? Де його використовувати?
